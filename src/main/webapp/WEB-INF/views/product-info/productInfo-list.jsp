							...
							<tbody>
								...
								<c:choose>
								    ...
								    <c:otherwise>
										...
										<td class="text-center"><a href='<c:url value="/product-info/view/${productInfo.id}" />' class="btn btn-round btn-default">View</a></td>
										<td class="text-center"><a href='<c:url value="/product-info/edit/${productInfo.id}" />' class="btn btn-round btn-primary">Edit</a></td>
										<td class="text-center"><a href="javascript:void(0);" onclick="confirmDelete(${productInfo.id});" class="btn btn-round btn-danger">Delete</a></td>
								</c:forEach>
							</tbody>
						</table>
