	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3 style="color: blue;">${titlePage}</h3>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						<br />
						<form:form modelAttribute="modelForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/product-info/save" 
						    ...
						    <div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">	
								    <!-- nếu không phải màn hình view(add, edit có viewOnly==false) ta sẽ được chọn category -->
								    <!-- còn nếu là màn hình view(viewOnly==true) thì sẽ chỉ hiện tên category ra thôi(k được chọn) -->
									<c:choose>
