...
public class LoginController {
	...
	// HttpSession: khi user đăng nhập thành công --> save thông tin của user vào trong session	
	...
	public String processLogin(Model model, @ModelAttribute("loginForm") @Validated Users users,
	    ...
	    // lưu menu này vào session:
	 	session.setAttribute(Constant.MENU_SESSION, menuList);   // session.setAttribute("menuSession",menuList) 
		// khi user login thành công ta sẽ có thông tin của user và lưu thông tin đó vào trong session
